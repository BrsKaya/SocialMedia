            ...
            if (context != null) {
                ...
                if (!context.Users.Any()) {
                    context.Users.AddRange(
                        new User { UserName = "BarisKaya", Image = "pp.png", UserId = 1,Password="1234567", Email="baris@info.com" },
                        new User { UserName = "Umut", Image = "pp.png", UserId = 2, Password="1234567", Email="umut@info.com" },
